...
public class NotificationListener extends BroadcastReceiver {
    ...
    public static String ACTION_NOTIFICATION = KeePassTransferApplication.class.getPackage() + ".ACTION_NOTIFICATION";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ClipboardListener clipboardListener = KeePassTransferService.getInstance().getClipboardListener();
